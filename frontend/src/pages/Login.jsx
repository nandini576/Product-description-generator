  ...
  return (
    <>
      ...
      <main className={`min-h-[80vh] flex items-center justify-center px-4 py-12 ${darkMode ? "bg-[#16231A]" : "bg-[#FAF8F3]"}`}>
        <div className={`rounded-3xl shadow-xl w-full max-w-md p-6 sm:p-8 md:p-10 ${darkMode ? "bg-[#243127] text-white" : "bg-white text-black"}`}>
          ...
          <p className="text-center mt-6 text-xs sm:text-sm font-bold text-black dark:text-white">
            ...
            <Link to="/register" className="text-green-700 dark:text-green-400 font-extrabold hover:underline">
              Register
            </Link>
          </p>
        </div>
